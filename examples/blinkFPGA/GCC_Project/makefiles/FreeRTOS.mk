...
SRCS+=$(addprefix $(FREERTOS_DIR)$(DIR_SEP),$(FREERTOS_SRCS))
OBJS+=$(addprefix output/,$(FREERTOS_SRCS:.c=.o))
...
SRCS+=$(addprefix $(FREERTOS_PORTABLE_QUICKLOGIC)$(DIR_SEP),$(FREERTOS_PORTABLE_SRCS))
OBJS+=$(addprefix output/,$(FREERTOS_PORTABLE_SRCS:.c=.o))
...
SRCS+=$(addprefix $(FREERTOS_PORTABLE_MEMMANG)$(DIR_SEP),$(FREERTOS_PORTABLE_MEMMANG_SRCS))
OBJS+=$(addprefix output/,$(FREERTOS_PORTABLE_MEMMANG_SRCS:.c=.o))
